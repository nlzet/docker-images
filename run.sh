...
prepare() {
  ...
  PHP_EXTENSIONS=${PHP_EXTENSIONS:-@composer amqp gd bcmath bz2 exif gd gettext gmp igbinary imagick intl mcrypt mongodb mysqli opcache pdo_mysql pdo_pgsql redis sockets soap xdebug xsl zip}
